...
func TestComputeSummary_GatewayAPISourceKinds(t *testing.T) {
	reports := []securityv1alpha1.TLSComplianceReport{
		...
		{Spec: securityv1alpha1.TLSComplianceReportSpec{SourceKind: securityv1alpha1.SourceKindTLSRoute},
			Status: securityv1alpha1.TLSComplianceReportStatus{ComplianceStatus: securityv1alpha1.ComplianceStatusCompliant}},
		{Spec: securityv1alpha1.TLSComplianceReportSpec{SourceKind: securityv1alpha1.SourceKindGRPCRoute},
			Status: securityv1alpha1.TLSComplianceReportStatus{ComplianceStatus: securityv1alpha1.ComplianceStatusCompliant}},
	...
	if s.BySourceKind[securityv1alpha1.SourceKindGRPCRoute] != 1 {
		t.Errorf("expected 1 GRPCRoute, got %d", s.BySourceKind[securityv1alpha1.SourceKindGRPCRoute])
	}
	...
	output := buf.String()
	for _, kind := range []string{"HTTPRoute:", "TLSRoute:", "GRPCRoute:", "Gateway:"} {
